import { Stack, TextareaAutosize, TextField, InputAdornment } from "@mui/material";
...
export const MuiTextField = () => {
    return(
        <Stack spacing={2}>
            ...
            <Stack>
                <TextareaAutosize aria-label="empty-textarea" placeholder="Type something" minRows={3} style={{width:200}}/>
            </Stack>
        </Stack>
    )
}